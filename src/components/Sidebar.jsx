...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className={`absolute right-0 top-0 md:hidden pr-3 ${isOpen ? 'z-0' : 'z-50'}`} onClick={toggleSidebar}> <i className="fa-solid fa-bars text-black bg-white text-3xl mt-[22.5px] -translate-x-4 bg-red px-2 rounded"></i></div>
